...
final class CameraConfigurationManager {
	 ...
	 * and decoding.
	 * We detect the preview format here so that buildLuminanceSource() can
	 * build an appropriate
	 * LuminanceSource subclass. In the future we may want to force YUV420SP as
	 * it's the smallest,
	 * and the planar Y can be used for barcode scanning without a copy in some
	 * cases.
	 */
